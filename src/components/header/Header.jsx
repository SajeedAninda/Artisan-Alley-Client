          ...
          <div className='relative px-4 py-4 flex justify-between items-center w-[95%] mx-auto'>
            <Link href='/'>
              <div className='flex gap-3 items-center'>
                ...
                <h2 className='text-2xl font-bold text-white'>Artisan Alley</h2>
              </div>
            </Link>

            <div className='lg:hidden'>
              <button
                className='navbar-burger flex items-center justify-end text-white text-2xl p-3'
                onClick={toggleMenu}
              >
                <TfiMenuAlt />
              </button>
            ...
            {loggedInUser ? (
              <div onClick={toggleLogout} className='pl-4 relative z-50'>
                <img
                  className='w-[70px] h-[70px] object-cover rounded-full border-4 hover:opacity-70 border-white cursor-pointer'
              ...
              <div className='flex gap-3'>
                <Link
                  href={'/login'}
                  className='hidden lg:inline-block cursor-pointer font-semibold overflow-hidden relative z-100 border border-white group px-6 py-2'
                >
                  <span className='relative z-10 text-white group-hover:text-[#926d5c] text-lg duration-500'>
                    Sign In
                  </span>
        ...
        >
          ...
          <div className='fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-[#926d5c] border-r overflow-y-auto'>
            <div className='flex justify-between items-center mb-8'>
              ...
              <button
                className='navbar-close flex items-end justify-end text-white text-2xl p-3'
                onClick={closeMenu}
              >
                <FaRegWindowClose />
              </button>
            ...
            <div
              className={`${
                loggedInUser ? 'hidden' : 'flex'
              } flex-col gap-3 mt-10`}
            >
              <Link
                href={'/login'}
                className='cursor-pointer font-semibold overflow-hidden relative z-100 border border-white group px-6 py-2'
              >
                <span className='relative z-10 text-white group-hover:text-[#926d5c] text-lg duration-500'>
                  Sign In
                </span>
