...
const Footer = () => {
    return (
        <div className="w-full flex items-center justify-center bg pt-16 pb-8">
            <div className="w-[90%] mx-auto px-4 text-white flex flex-col">
                ...
                <div className="flex mt-8 flex-col md:flex-row md:justify-between items-center">
                    ...
                    <button className="mt-8 md:mt-0 lg:inline-block cursor-pointer font-semibold overflow-hidden relative z-100 border border-white group px-6 py-2">
                ...
                <div className="flex flex-col">
                    <div className="flex mt-24 mb-12 flex-col gap-6 lg:gap-0 lg:flex-row justify-between items-center">
                        ...
                        <a className="md:block cursor-pointer text-white hover:text-white uppercase hover:opacity-50">Home</a>
                        <a className="md:block cursor-pointer text-white hover:text-white uppercase hover:opacity-50">Products</a>
                        <a className="md:block cursor-pointer text-white hover:text-white uppercase hover:opacity-50">Artisans</a>
                        <a className="md:block cursor-pointer text-white hover:text-white uppercase hover:opacity-50">Events</a>
                        <a className="md:block cursor-pointer text-white hover:text-white uppercase hover:opacity-50">Community</a>
